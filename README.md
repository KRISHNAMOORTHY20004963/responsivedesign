...
<body>
    ...
    <div class="row">
        <div class="col-12">
            <p>Copyright © 2021 Silicon Private Limited, Developed by Travis Scott.</p>
        </div>
    </div>
...
<body>
    ...
    <div class="row text-center">
        ...
        <div class="card col-12 col-md-6 col-lg-3">
            ...
            <div class="card-body">
                <h5 class="card-title">Wiz Khalifa</h5>
...
<body>
    ...
    <div class="contactuscontent">
        ...
        <div class="contactustext">
            ...
            <h2> Ilabs India Private Limited 9th Floor, Maximus Towers 2B, Raheja Mindspace IT Park, APIIC Software
                Layout,
...
## RESULT:
Thus a website is designed for the responsive with two break points and is hosted in the URL http://krishnamoorthy.student.saveetha.in:8000/productsresponsive/. HTML code is validated.